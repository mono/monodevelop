...
type ProjectTests() =
  ...
  <ItemGroup>
    ...
    //member this.``Adds new image assets``() =
        ...
        //        //let project = Services.ProjectService.CreateDotNetProject ("F#")
        //        //project.FileName <- FilePath(projectPath)
        //        //let group = project.MSBuildProject.AddNewItemGroup()
        //        //let x = group.AddNewItem("Reference", "System")
        //        //let group = project.MSBuildProject.AddNewItemGroup()
        //        //let x = group.AddNewItem("Folder", "/Resources")
        //        //let group = project.MSBuildProject.AddNewItemGroup()
        //        //let x = group.AddNewItem("Compile", "source.fs")
        //        //let files =
        //        //    [ path / "Properties" / "AndroidManifest.xml", "ImageAsset"
        //        //      path / "Services" / "Parser.fs", "ImageAsset"
        //        //      path / "MainActivity.fs", "ImageAsset"
        //        //      path / "Properties" / "AssemblyInfo.fs", "ImageAsset" ]
