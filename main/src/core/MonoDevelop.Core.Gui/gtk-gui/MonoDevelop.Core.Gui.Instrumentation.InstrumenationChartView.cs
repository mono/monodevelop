...
namespace MonoDevelop.Core.Gui.Instrumentation
{
	internal partial class InstrumenationChartView
	{
		...
		protected virtual void Build ()
		{
			...
			// Widget MonoDevelop.Core.Gui.Instrumentation.InstrumenationChartView
			global::Stetic.BinContainer.Attach (this);
			this.Name = "MonoDevelop.Core.Gui.Instrumentation.InstrumenationChartView";
			// Container child MonoDevelop.Core.Gui.Instrumentation.InstrumenationChartView.Gtk.Container+ContainerChild
