...
namespace MonoDevelop.Core.Gui.Instrumentation
{
	internal partial class TimeLineViewWindow
	{
		...
		private global::MonoDevelop.Core.Gui.Instrumentation.TimeLineView timeView;
		...
		protected virtual void Build ()
		{
			...
			// Widget MonoDevelop.Core.Gui.Instrumentation.TimeLineViewWindow
			this.Name = "MonoDevelop.Core.Gui.Instrumentation.TimeLineViewWindow";
			this.Title = global::Mono.Unix.Catalog.GetString ("Time Line");
			this.WindowPosition = ((global::Gtk.WindowPosition)(4));
			// Container child MonoDevelop.Core.Gui.Instrumentation.TimeLineViewWindow.Gtk.Container+ContainerChild
			...
			this.timeView = new global::MonoDevelop.Core.Gui.Instrumentation.TimeLineView ();
