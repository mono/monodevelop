...
namespace MonoDevelop.Core.Gui.Instrumentation
{
	public partial class CounterSelectorDialog
	{
		...
		protected virtual void Build ()
		{
			...
			// Widget MonoDevelop.Core.Gui.Instrumentation.CounterSelectorDialog
			this.Name = "MonoDevelop.Core.Gui.Instrumentation.CounterSelectorDialog";
			this.Title = global::Mono.Unix.Catalog.GetString ("Select Counter");
			this.WindowPosition = ((global::Gtk.WindowPosition)(4));
			// Internal child MonoDevelop.Core.Gui.Instrumentation.CounterSelectorDialog.VBox
			...
			w3.Position = 0;
			// Internal child MonoDevelop.Core.Gui.Instrumentation.CounterSelectorDialog.ActionArea
