...
namespace MonoDevelop.Core.Gui.Dialogs
{
	public partial class ProgressDialog
	{
		...
		protected virtual void Build ()
		{
			...
			// Widget MonoDevelop.Core.Gui.Dialogs.ProgressDialog
			this.Name = "MonoDevelop.Core.Gui.Dialogs.ProgressDialog";
			this.Title = global::Mono.Unix.Catalog.GetString ("MonoDevelop");
			this.WindowPosition = ((global::Gtk.WindowPosition)(4));
			this.Modal = true;
			// Internal child MonoDevelop.Core.Gui.Dialogs.ProgressDialog.VBox
			...
			w10.Position = 0;
			// Internal child MonoDevelop.Core.Gui.Dialogs.ProgressDialog.ActionArea
