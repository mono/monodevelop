...
namespace MonoDevelop.Core.Gui.Dialogs
{
	public partial class ErrorDialog
	{
		...
		protected virtual void Build ()
		{
			...
			// Widget MonoDevelop.Core.Gui.Dialogs.ErrorDialog
			this.Name = "MonoDevelop.Core.Gui.Dialogs.ErrorDialog";
			this.Title = global::Mono.Unix.Catalog.GetString ("MonoDevelop");
			this.WindowPosition = ((global::Gtk.WindowPosition)(4));
			// Internal child MonoDevelop.Core.Gui.Dialogs.ErrorDialog.VBox
			...
			w8.Position = 0;
			// Internal child MonoDevelop.Core.Gui.Dialogs.ErrorDialog.ActionArea
