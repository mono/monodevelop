...
namespace MonoDevelop.Ide.Projects.OptionPanels
{
	internal partial class RuntimeOptionsPanelWidget
	{
		...
		{
			runtimeVersionCombo.SetCommonAccessibilityAttributes (
				"RuntimeOptionsPanel.TargetFrameworkComboBox",
				label114,
				GettextCatalog.GetString ("Select the target framework for the project"));
		}
	}
}
