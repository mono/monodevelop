...
namespace MonoDevelop.Ide.Gui.Dialogs
{
	internal partial class GoToDialog
	{
		...
		protected virtual void Build ()
		{
			...
			this.Title = global::MonoDevelop.Core.GettextCatalog.GetString ("Go to File");
			...
			this.toggleFiles.Label = global::MonoDevelop.Core.GettextCatalog.GetString ("Search _Files");
			...
			this.toggleTypes.Label = global::MonoDevelop.Core.GettextCatalog.GetString ("Search _Types");
			...
			this.label1.LabelProp = global::MonoDevelop.Core.GettextCatalog.GetString ("_Name:");
