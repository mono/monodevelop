...
namespace MonoDevelop.Ide.Composition
{
    ...
    /// </summary>
    internal sealed class MonoDevelopMefHostServices : HostServices, IMefHostExportProvider
    {
        ...
        private MonoDevelopMefHostServices(ExportProvider exportProvider)
        {
            Contract.ThrowIfNull(exportProvider);
            _exportProvider = exportProvider;
        }

        public static MonoDevelopMefHostServices Create(ExportProvider exportProvider)
            => new MonoDevelopMefHostServices (exportProvider);
