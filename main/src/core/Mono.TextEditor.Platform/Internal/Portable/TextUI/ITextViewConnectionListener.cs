...
namespace Microsoft.VisualStudio.Text.Editor
{
    ...
    public interface ITextViewConnectionListener
    {
        ...
        /// content types.</param>
        void SubjectBuffersConnected(ITextView textView, ConnectionReason reason, Collection<ITextBuffer> subjectBuffers);
        ...
        void SubjectBuffersDisconnected(ITextView textView, ConnectionReason reason, Collection<ITextBuffer> subjectBuffers);
    }
}
