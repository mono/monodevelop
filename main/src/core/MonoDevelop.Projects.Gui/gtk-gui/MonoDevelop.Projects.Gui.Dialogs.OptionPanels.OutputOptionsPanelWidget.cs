...
namespace MonoDevelop.Projects.Gui.Dialogs.OptionPanels {
    ...
    internal partial class OutputOptionsPanelWidget {
        ...
        protected virtual void Build() {
            ...
            // Widget MonoDevelop.Projects.Gui.Dialogs.OptionPanels.OutputOptionsPanelWidget
            Stetic.BinContainer.Attach(this);
            this.Name = "MonoDevelop.Projects.Gui.Dialogs.OptionPanels.OutputOptionsPanelWidget";
            // Container child MonoDevelop.Projects.Gui.Dialogs.OptionPanels.OutputOptionsPanelWidget.Gtk.Container+ContainerChild
            ...
            this.label93.LabelProp = MonoDevelop.Core.GettextCatalog.GetString("<b>Output</b>");
            this.label93.UseMarkup = true;
            this.vbox67.Add(this.label93);
            Gtk.Box.BoxChild w1 = ((Gtk.Box.BoxChild)(this.vbox67[this.label93]));
            w1.Position = 0;
            w1.Expand = false;
            w1.Fill = false;
            // Container child vbox67.Gtk.Box+BoxChild
            ...
            this.assemblyNameEntry = new Gtk.Entry();
            ...
            Gtk.Table.TableChild w3 = ((Gtk.Table.TableChild)(this.table10[this.assemblyNameEntry]));
