...
namespace MonoDevelop.VersionControl
{
	public abstract class VersionControlSystem
	{
		...
		public virtual string GetOutputDirectoryPath (string defaultPath, string relativePath)
		{
			return defaultPath + relativePath.Replace ('/', System.IO.Path.DirectorySeparatorChar);
		}
	}
}
