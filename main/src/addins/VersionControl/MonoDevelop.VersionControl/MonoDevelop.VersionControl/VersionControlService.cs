...
*/
		...
		{
			return GetConfiguration ().DisabledSolutions.Contains (it.FileName);
		}

		public static void SetSolutionDisabled (Solution it, bool value)
		{
			if (value)
				GetConfiguration ().DisabledSolutions.Add (it.FileName);
			else
				GetConfiguration ().DisabledSolutions.Remove (it.FileName);
