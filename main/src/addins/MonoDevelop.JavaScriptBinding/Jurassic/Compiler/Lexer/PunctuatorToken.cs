...
namespace Jurassic.Compiler
{
	...
	public class PunctuatorToken : Token
	{
		...
		static readonly Dictionary<string, PunctuatorToken> punctuatorLookupTable = new Dictionary<string, PunctuatorToken> () {
			{ "{", LeftBrace },
			{ "}", RightBrace },
			{ "(", LeftParenthesis },
			{ ")", RightParenthesis },
		...
		public static PunctuatorToken FromString (string text)
		{
			...
			if (!punctuatorLookupTable.TryGetValue (text, out result))
				return null;
			return result;
		}
