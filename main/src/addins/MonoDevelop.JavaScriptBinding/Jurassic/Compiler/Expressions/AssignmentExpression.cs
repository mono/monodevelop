...
namespace Jurassic.Compiler
{
	...
	public class AssignmentExpression : OperatorExpression
	{
		...
		{
			Push (new NameExpression (scope, name));
			Push (value);
		}
		...
		public IReferenceExpression Target {
			get { return GetOperand (0) as IReferenceExpression; }
		}
		...
		public override PrimitiveType ResultType {
			get {
				...
				var compoundOperator = new BinaryExpression (GetCompoundBaseOperator (type), GetOperand (0), GetOperand (1));
