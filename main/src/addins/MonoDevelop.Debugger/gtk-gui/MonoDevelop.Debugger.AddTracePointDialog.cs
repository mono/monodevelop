...
namespace MonoDevelop.Debugger {
    ...
    public partial class AddTracePointDialog {
        ...
        protected virtual void Build() {
            ...
            this.Title = Mono.Unix.Catalog.GetString("Add Tracepoint");
            ...
            Gtk.Table.TableChild w2 = ((Gtk.Table.TableChild)(this.table1[this.entryCondition]));
            w2.TopAttach = ((uint)(2));
            ...
            Gtk.Table.TableChild w3 = ((Gtk.Table.TableChild)(this.table1[this.entryTrace]));
            ...
            this.label1.LabelProp = Mono.Unix.Catalog.GetString("Trace Text:");
            ...
            this.label2.LabelProp = Mono.Unix.Catalog.GetString("Condition:");
            ...
            this.label3.LabelProp = Mono.Unix.Catalog.GetString("<small>Expressions to be evaluated by the debugger can be included in the text by surrounding them with curly braces, for example: \"Value is {n}\".</small>");
            ...
            this.label4.LabelProp = Mono.Unix.Catalog.GetString("<small>When set, the text will be printed only when this condition evaluates to true.</small>");
