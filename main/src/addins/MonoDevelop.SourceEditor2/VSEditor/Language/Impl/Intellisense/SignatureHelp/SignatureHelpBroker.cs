...
namespace Microsoft.VisualStudio.Language.Intellisense.Implementation
{
	...
	{
		[ImportMany]
		internal List<Lazy<ISignatureHelpSourceProvider, IOrderableContentTypeMetadata>> UnOrderedSignatureHelpSourceProviderExports { get; set; }

		[ImportMany]
		private List<Lazy<IIntellisensePresenterProvider, IOrderableContentTypeMetadata>> UnOrderedIntellisensePresenterProviderExports { get; set; }
