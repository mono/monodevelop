...
{
	public partial class InspectionOptions
	{
		...
		protected virtual void Build ()
		{
			...
			// Widget MonoDevelop.Inspection.InspectionOptions
			this.Name = "MonoDevelop.Inspection.InspectionOptions";
			this.Title = global::Mono.Unix.Catalog.GetString ("Inspection Options");
			this.TypeHint = ((global::Gdk.WindowTypeHint)(1));
			this.WindowPosition = ((global::Gtk.WindowPosition)(1));
			this.Modal = true;
			this.BorderWidth = ((uint)(6));
			this.Resizable = false;
			// Internal child MonoDevelop.Inspection.InspectionOptions.VBox
			...
			w8.Fill = false;
			w8.Padding = ((uint)(6));
			// Internal child MonoDevelop.Inspection.InspectionOptions.ActionArea
