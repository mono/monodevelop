...
namespace MonoDevelop.XmlEditor
{
	...
	/// MonoDevelop.Projects.Gui.Completion.ListWindow
	/// </summary>
	/// <remarks>
	/// Xml completion requires the list to match on items
	/// that may contain punctuation characters 
	/// (e.g. forward slashes in namespaces, colons in 
	/// prefixed element names).
	/// </remarks>
	public class XmlEditorListWindow : Gtk.Window
	{
		...
		protected XmlEditorListWidget List
		{
			get { return list; }
		}
		...
		public KeyAction ProcessKey (EventKey e)
		{
			...
			if (System.Char.IsLetterOrDigit (c) || c == '_' || IsValidCompletionChar(c)) {
	...
	public class XmlEditorListWidget: Gtk.DrawingArea
	{
		int margin = 0;
		int padding = 4;
		int listWidth = 300;
		...
		public XmlEditorListWidget (XmlEditorListWindow win)
		{
			this.win = win;
