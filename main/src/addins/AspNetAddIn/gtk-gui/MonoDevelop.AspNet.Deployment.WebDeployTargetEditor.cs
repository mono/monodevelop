...
namespace MonoDevelop.AspNet.Deployment {
    ...
    public partial class WebDeployTargetEditor {
        ...
        private Gtk.HBox fileCopyHbox;
        
        private Gtk.Label label5;
        
        private Gtk.VBox vbox3;
        
        private Gtk.HBox fileCopyBox;
        ...
        protected virtual void Build() {
            ...
            this.Title = MonoDevelop.Core.GettextCatalog.GetString("Edit Web Deployment Target");
            ...
            this.label8.LabelProp = MonoDevelop.Core.GettextCatalog.GetString("Name:");
            this.table2.Add(this.label8);
            Gtk.Table.TableChild w4 = ((Gtk.Table.TableChild)(this.table2[this.label8]));
            ...
            Gtk.Table.TableChild w5 = ((Gtk.Table.TableChild)(this.table2[this.nameEntry]));
            ...
            w1.Add(this.label2);
            Gtk.Box.BoxChild w9 = ((Gtk.Box.BoxChild)(w1[this.label2]));
            w9.Position = 2;
            w9.Expand = false;
            w9.Fill = false;
            // Container child dialog1_VBox.Gtk.Box+BoxChild
            this.fileCopyHbox = new Gtk.HBox();
            ...
            Gtk.Box.BoxChild w10 = ((Gtk.Box.BoxChild)(this.fileCopyHbox[this.label5]));
            w10.Position = 0;
            w10.Expand = false;
            w10.Fill = false;
            // Container child fileCopyHbox.Gtk.Box+BoxChild
            ...
            this.fileCopyBox = new Gtk.HBox();
            this.fileCopyBox.Name = "fileCopyBox";
            this.fileCopyBox.Spacing = 6;
            this.vbox3.Add(this.fileCopyBox);
            Gtk.Box.BoxChild w11 = ((Gtk.Box.BoxChild)(this.vbox3[this.fileCopyBox]));
            w11.Position = 0;
            this.fileCopyHbox.Add(this.vbox3);
            Gtk.Box.BoxChild w12 = ((Gtk.Box.BoxChild)(this.fileCopyHbox[this.vbox3]));
            w12.Position = 1;
            w1.Add(this.fileCopyHbox);
            Gtk.Box.BoxChild w13 = ((Gtk.Box.BoxChild)(w1[this.fileCopyHbox]));
            w13.Position = 3;
