	...
	public class WebReferenceCommandHandler : NodeCommandHandler
	{
		...
		async Task UpdateReferences (IList<WebReferenceItem> items)
		{
			...
			try {
				...
				IdeApp.StatusService.MainContext.ShowMessage (GettextCatalog.GetPluralString ("Updated Web Reference {0}", "Updated Web References", items.Count, items [0].Name));
			} finally {
		...
		public void Delete()
		{
			...
			IdeApp.StatusService.MainContext.ShowMessage(GettextCatalog.GetString ("Deleted Web Reference {0}", item.Name));
		}
		...
		public void DeleteAll()
		{
			...
			IdeApp.StatusService.MainContext.ShowMessage(GettextCatalog.GetString ("Deleted all Web References"));
		}
