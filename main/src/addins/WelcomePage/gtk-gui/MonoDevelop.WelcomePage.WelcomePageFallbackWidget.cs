...
namespace MonoDevelop.WelcomePage {
    ...
    public partial class WelcomePageFallbackWidget {
        ...
        protected virtual void Build() {
            ...
            this.headerRecentProj.LabelProp = "";
            ...
            this.filler2.LabelProp = "";
            this.hbox2.Add(this.filler2);
            Gtk.Box.BoxChild w8 = ((Gtk.Box.BoxChild)(this.hbox2[this.filler2]));
            w8.Position = 1;
            this.vbox3.Add(this.hbox2);
            Gtk.Box.BoxChild w9 = ((Gtk.Box.BoxChild)(this.vbox3[this.hbox2]));
            w9.Position = 0;
            // Container child vbox3.Gtk.Box+BoxChild
            ...
            Gtk.Table.TableChild w10 = ((Gtk.Table.TableChild)(this.recentFilesTable[this.hseparator1]));
            ...
            this.projNameLabel.LabelProp = "";
            this.recentFilesTable.Add(this.projNameLabel);
            Gtk.Table.TableChild w11 = ((Gtk.Table.TableChild)(this.recentFilesTable[this.projNameLabel]));
            w11.YOptions = ((Gtk.AttachOptions)(4));
            // Container child recentFilesTable.Gtk.Table+TableChild
            this.projTimeLabel = new Gtk.Label();
            this.projTimeLabel.Name = "projTimeLabel";
            this.projTimeLabel.Xalign = 1F;
            this.projTimeLabel.LabelProp = "";
            this.recentFilesTable.Add(this.projTimeLabel);
            Gtk.Table.TableChild w12 = ((Gtk.Table.TableChild)(this.recentFilesTable[this.projTimeLabel]));
            w12.LeftAttach = ((uint)(1));
            w12.RightAttach = ((uint)(2));
            w12.YOptions = ((Gtk.AttachOptions)(4));
            this.vbox3.Add(this.recentFilesTable);
            Gtk.Box.BoxChild w13 = ((Gtk.Box.BoxChild)(this.vbox3[this.recentFilesTable]));
            w13.Position = 1;
            w13.Expand = false;
            w13.Fill = false;
            this.hbox4.Add(this.vbox3);
            Gtk.Box.BoxChild w14 = ((Gtk.Box.BoxChild)(this.hbox4[this.vbox3]));
            w14.Position = 1;
            ...
            this.headerSupportLinks.LabelProp = "";
            this.headerSupportLinks.UseMarkup = true;
            this.vbox1.Add(this.headerSupportLinks);
            Gtk.Box.BoxChild w17 = ((Gtk.Box.BoxChild)(this.vbox1[this.headerSupportLinks]));
            w17.Position = 0;
            w17.Expand = false;
            w17.Fill = false;
            // Container child vbox1.Gtk.Box+BoxChild
            ...
            Gtk.Box.BoxChild w18 = ((Gtk.Box.BoxChild)(this.hbox5[this.label6]));
            w18.Position = 0;
            w18.Expand = false;
            w18.Fill = false;
            // Container child hbox5.Gtk.Box+BoxChild
            ...
            Gtk.Box.BoxChild w19 = ((Gtk.Box.BoxChild)(this.hbox5[this.supportLinkBox]));
            w19.Position = 1;
            this.vbox1.Add(this.hbox5);
            Gtk.Box.BoxChild w20 = ((Gtk.Box.BoxChild)(this.vbox1[this.hbox5]));
            w20.Position = 1;
            w20.Expand = false;
            w20.Fill = false;
            // Container child vbox1.Gtk.Box+BoxChild
            ...
            Gtk.Box.BoxChild w21 = ((Gtk.Box.BoxChild)(this.vbox1[this.label7]));
            w21.Position = 2;
            w21.Expand = false;
            w21.Fill = false;
            // Container child vbox1.Gtk.Box+BoxChild
            ...
            this.headerDevLinks.LabelProp = "";
            this.headerDevLinks.UseMarkup = true;
            this.vbox1.Add(this.headerDevLinks);
            Gtk.Box.BoxChild w22 = ((Gtk.Box.BoxChild)(this.vbox1[this.headerDevLinks]));
            w22.Position = 3;
            w22.Expand = false;
            w22.Fill = false;
            // Container child vbox1.Gtk.Box+BoxChild
            ...
            Gtk.Box.BoxChild w24 = ((Gtk.Box.BoxChild)(this.hbox6[this.devLinkBox]));
            w24.Position = 1;
            this.vbox1.Add(this.hbox6);
            Gtk.Box.BoxChild w25 = ((Gtk.Box.BoxChild)(this.vbox1[this.hbox6]));
            w25.Position = 4;
            w25.Expand = false;
            w25.Fill = false;
            this.hbox1.Add(this.vbox1);
            Gtk.Box.BoxChild w26 = ((Gtk.Box.BoxChild)(this.hbox1[this.vbox1]));
            w26.Position = 1;
            w26.Expand = false;
            w26.Fill = false;
