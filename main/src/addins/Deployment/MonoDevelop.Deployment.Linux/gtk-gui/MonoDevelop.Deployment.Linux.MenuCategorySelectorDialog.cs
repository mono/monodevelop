...
namespace MonoDevelop.Deployment.Linux {
    ...
    public partial class MenuCategorySelectorDialog {
        ...
        protected virtual void Build() {
            ...
            this.label19.LabelProp = Mono.Unix.Catalog.GetString("Select the categories you want to assign to the desktop entry:");
            this.vbox5.Add(this.label19);
            Gtk.Box.BoxChild w2 = ((Gtk.Box.BoxChild)(this.vbox5[this.label19]));
            w2.Position = 0;
            w2.Expand = false;
            w2.Fill = false;
            // Container child vbox5.Gtk.Box+BoxChild
