...
namespace MonoDevelop.CSharp.Project
{
	partial class CompilerOptionsPanelWidget
	{
		...
		private global::Gtk.Entry codepageEntry;
		...
		protected virtual void Build ()
		{
			...
			var codePageHBox = new Gtk.HBox ();
			codePageHBox.Spacing = 6;
			this.codepageEntry = new Gtk.Entry ();
			this.codepageEntry.Name = "codepageEntry";
			codePageHBox.PackStart (codepageEntry);
			this.table7.Add (codePageHBox);
			codePageMenuButton = new MenuButton ();
			codePageHBox.PackStart (codePageMenuButton, false, false, 0);
			global::Gtk.Table.TableChild w3 = ((global::Gtk.Table.TableChild)(this.table7 [codePageHBox]));
			w3.TopAttach = ((uint)(3));
