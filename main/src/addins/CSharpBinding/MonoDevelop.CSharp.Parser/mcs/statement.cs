...
namespace Mono.CSharp {
	...
	public class Block : Statement {
		...
		/// <summary>
		/// Is true for blocks that are generated by the parser and are not part of the source file.
		/// </summary>
		public bool IsGenerated {
			get { return (flags & Flags.IsGenerated) != 0; }
			set { flags = value ? flags | Flags.IsGenerated : flags & ~Flags.IsGenerated; }
		}
...
//					throw new Exception ("Variables have not been initialized yet");
	...
	public class Fixed : Statement {
		...
		public List<KeyValuePair<LocalInfo, Expression>> Declarators {
	...
	public class Catch : Statement {
		...
		public Expression Type_expr {
			get { return this.type_expr; }
		}
