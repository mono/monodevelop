...
namespace CBinding.Formatting
{
	public partial class NewFormattingProfileDialog
	{
		...
		protected virtual void Build ()
		{
			...
			// Widget CBinding.Formatting.NewFormattingProfileDialog
			this.Name = "CBinding.Formatting.NewFormattingProfileDialog";
			this.Title = global::Mono.Unix.Catalog.GetString ("New Profile");
			this.WindowPosition = ((global::Gtk.WindowPosition)(4));
			this.BorderWidth = ((uint)(6));
			// Internal child CBinding.Formatting.NewFormattingProfileDialog.VBox
			...
			w6.Expand = false;
			w6.Fill = false;
			// Internal child CBinding.Formatting.NewFormattingProfileDialog.ActionArea
