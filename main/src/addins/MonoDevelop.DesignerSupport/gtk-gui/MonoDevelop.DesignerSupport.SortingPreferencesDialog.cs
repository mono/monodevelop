...
namespace MonoDevelop.DesignerSupport
{
	public partial class SortingPreferencesDialog
	{
		...
		protected virtual void Build ()
		{
			...
			// Widget MonoDevelop.DesignerSupport.SortingPreferencesDialog
			this.Name = "MonoDevelop.DesignerSupport.SortingPreferencesDialog";
			this.Title = global::Mono.Unix.Catalog.GetString ("Document Outline Preferences");
			this.WindowPosition = ((global::Gtk.WindowPosition)(4));
			this.Modal = true;
			this.DestroyWithParent = true;
			// Internal child MonoDevelop.DesignerSupport.SortingPreferencesDialog.VBox
			...
			w4.Position = 0;
			// Internal child MonoDevelop.DesignerSupport.SortingPreferencesDialog.ActionArea
