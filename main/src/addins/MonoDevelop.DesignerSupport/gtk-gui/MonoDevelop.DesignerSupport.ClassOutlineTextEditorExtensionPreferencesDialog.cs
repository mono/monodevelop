...
{
	public partial class ClassOutlineTextEditorExtensionPreferencesDialog
	{
		...
		protected virtual void Build ()
		{
			...
			// Widget MonoDevelop.DesignerSupport.ClassOutlineTextEditorExtensionPreferencesDialog
			this.Name = "MonoDevelop.DesignerSupport.ClassOutlineTextEditorExtensionPreferencesDialog";
			this.Title = global::Mono.Unix.Catalog.GetString ("Document Outline Preferences");
			this.WindowPosition = ((global::Gtk.WindowPosition)(4));
			this.Modal = true;
			this.DestroyWithParent = true;
			// Internal child MonoDevelop.DesignerSupport.ClassOutlineTextEditorExtensionPreferencesDialog.VBox
			...
			this.label.LabelProp = global::Mono.Unix.Catalog.GetString ("This priority list defines the order in which groups are shown while grouping is active.");
			...
			w4.Position = 0;
			// Internal child MonoDevelop.DesignerSupport.ClassOutlineTextEditorExtensionPreferencesDialog.ActionArea
