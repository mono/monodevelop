...
// $ANTLR 3.4 CSS3.g3 2013-07-16 09:42:06
...
public partial class CSS3Parser : Antlr.Runtime.Parser
{
			...
			case 1:
				...
				while (true)
				{
					...
					case HASH:
						...
						if ((EvaluatePredicate(synpred1_CSS3_fragment)))
						{
							alt15 = 1;
						}
	...
	private static class Follow
	{
		...
		public static readonly BitSet _elementName_in_simpleSelector669 = new BitSet(new ulong[]{0x8008020802UL});
		public static readonly BitSet _elementSubsequent_in_simpleSelector685 = new BitSet(new ulong[]{0x8008020802UL});
		public static readonly BitSet _elementSubsequent_in_simpleSelector709 = new BitSet(new ulong[]{0x8008020802UL});
