...
namespace MonoDevelop.Projects.Gui.Deployment {
    ...
    public partial class CommandDeployEditorWidget {
        ...
        private Gtk.Entry argsEntry;
        
        private Gtk.CheckButton checkExternal;
        
        private Gtk.CheckButton checkDisposeExternal;
        
        protected virtual void Build() {
            // Widget MonoDevelop.Projects.Gui.Deployment.CommandDeployEditorWidget
            ...
            Gtk.Box.BoxChild w2 = ((Gtk.Box.BoxChild)(this.vbox1[this.cmdEntry]));
            w2.Position = 1;
            w2.Expand = false;
            w2.Fill = false;
            // Container child vbox1.Gtk.Box+BoxChild
            ...
            this.label2.LabelProp = "Arguments:";
            ...
            Gtk.Box.BoxChild w4 = ((Gtk.Box.BoxChild)(this.vbox1[this.argsEntry]));
            w4.Position = 3;
            w4.Expand = false;
            w4.Fill = false;
            // Container child vbox1.Gtk.Box+BoxChild
            ...
            this.checkExternal.Label = "Run in external console";
            ...
            this.checkDisposeExternal.Label = "Dispose console after running";
            ...
            this.Show();
            this.cmdEntry.Changed += new System.EventHandler(this.OnCmdEntryChanged);
            this.argsEntry.Changed += new System.EventHandler(this.OnArgsEntryChanged);
            this.checkExternal.Clicked += new System.EventHandler(this.OnCheckExternalClicked);
            this.checkDisposeExternal.Clicked += new System.EventHandler(this.OnCheckDisposeExternalClicked);
        }
    }
}
