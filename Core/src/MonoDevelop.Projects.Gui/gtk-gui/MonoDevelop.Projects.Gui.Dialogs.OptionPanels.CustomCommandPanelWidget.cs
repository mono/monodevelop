...
namespace MonoDevelop.Projects.Gui.Dialogs.OptionPanels {
    ...
    public partial class CustomCommandPanelWidget {
        ...
        protected virtual void Build() {
            ...
            this.label3.LabelProp = Mono.Unix.Catalog.GetString("MonoDevelop can execute user specified commands or scripts before, after or as a replacement of common project operations. It is also possible to enter custom commands which will be available in the project or solution menu.");
